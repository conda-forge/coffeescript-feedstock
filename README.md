...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/coffeescript-feedstock/blob/main/LICENSE.txt)

Summary: Unfancy JavaScript

Development: https://github.com/jashkenas/coffeescript
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3826&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/coffeescript-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `coffeescript` can be installed with `conda`:
...
```
mamba install coffeescript
```

It is possible to list all of the versions of `coffeescript` available on your platform with `conda`:
...
```
mamba search coffeescript --channel conda-forge
```
...
mamba repoquery search coffeescript --channel conda-forge

# List packages depending on `coffeescript`:
mamba repoquery whoneeds coffeescript --channel conda-forge

# List dependencies of `coffeescript`:
mamba repoquery depends coffeescript --channel conda-forge
```
